#ifndef COMPOSITION_COUNTER_TEST_TYPES_H
#define COMPOSITION_COUNTER_TEST_TYPES_H
...
} cmp_counter_test_launcher_driver_t;
...
} cmp_counter_test_launcher_infrastructure_t;
...
} cmp_counter_test_launcher_application_t;
...
} cmp_counter_test_launcher_presentation_t;

typedef struct {
    cmp_counter_test_launcher_driver_t         driver;
    cmp_counter_test_launcher_infrastructure_t infrastructure;
    cmp_counter_test_launcher_application_t    application;
    cmp_counter_test_launcher_presentation_t   presentation;
} cmp_counter_test_launcher_t;

#ifdef __cplusplus
}
#endif

#endif /* COMPOSITION_COUNTER_TEST_TYPES_H */
