#ifndef COMPOSITION_INFRARED_TYPES_H
#define COMPOSITION_INFRARED_TYPES_H
...
} cmp_infrared_launcher_driver_t;
...
} cmp_infrared_launcher_infrastructure_t;
...
} cmp_infrared_launcher_application_t;
...
} cmp_infrared_launcher_presentation_t;

typedef struct {
    cmp_infrared_launcher_driver_t         driver;
    cmp_infrared_launcher_infrastructure_t infrastructure;
    cmp_infrared_launcher_application_t    application;
    cmp_infrared_launcher_presentation_t   presentation;
} cmp_infrared_launcher_t;

#ifdef __cplusplus
}
#endif

#endif /* COMPOSITION_INFRARED_TYPES_H */
